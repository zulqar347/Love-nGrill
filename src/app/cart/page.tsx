    ...
    <div>
      ...
      <div className="flex items-center mb-10 justify-center gap-4 flex-col md:flex-row md:justify-around">
        {steps.map((step) => (
          ...
          >
            <div
              className={`rounded-full px-3 py-2 text-sm ${activeStep === step.id ? "bg-gray-600" : "bg-gray-300"}`}
            >
              {step.id}
            </div>
            <p
              className={`pb-1 ${activeStep === step.id ? "text-gray-800 border-b-4 border-gray-600" : "text-gray-400 border-b-4 border-gray-300"}`}
            >
              {step.name}
            </p>
          </div>
      ...
      <div className="flex flex-col md:flex-row gap-2 text-sm ">
              ...
              {cart.map((item) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="cursor-pointer text-red-500 hover:text-red-300 transition-all">
                      <Trash2
                        className="w-4 h-4"
        ...
        <div className="w-full md:w-5/12 shadow shadow-gray-300 p-4 flex flex-col gap-3 max-h-fit">
          <h1 className="text-gray-900 font-bold">Cart Details</h1>
          {/* subtotal */}
          ...
          {activeStep === "1" && (
            <button
              ...
              className="flex items-center justify-center w-full bg-gray-700 text-gray-200 p-1 rounded-lg"
            >
              Continue <ArrowRight />
            </button>
          )}
